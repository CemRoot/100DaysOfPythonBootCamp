...
EMAIL_ID = "Koyluoglu.cem@lll.kpi.ua"
PASSWORD = "!!!Hamam123"
PHONE = "1234567891"
...
#   created exception handling, because in some cases if any element isn't available, still our code will run perfectly
    try:
        ...
        # if submit button is available in page onliest than fill the form, otherwise it has multi steps to fill form.
        if submit_button.text == 'Submit application':
            ...
            time.sleep(2)
            discard_button = driver.find_element(By.CSS_SELECTOR, '.artdeco-modal__actionbar--confirm-dialog span').click()
